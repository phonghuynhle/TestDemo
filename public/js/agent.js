$(document).ready(function () {
  ...
  //     $.ajax({
  //         url: `http://20.254.253.173/api/v1/hotels/deleteHotel/${id}`,
  //         method: "DELETE",
  //         success: function (data) {
  //             renderPage();
  ...
  $(document).on("click", ".updateHotel", function () {
    ...
    $.ajax({
      url: `http://20.254.253.173/api/v1/hotels/${id}`,
      method: "GET",
      success: function (data) {
        console.log("2");
        console.log(data);
        ...
        $(".ebutton").click(function () {
          ...
          // alert(apayment);
          $.ajax({
            url: `http://20.254.253.173/api/v1/hotels/updateHotel/${id}`,
            method: "PUT",
            data: {
              name: name,
              star: star,
  ...
  $(document).on("click", ".fa-image", function () {
    ...
    $.ajax({
      url: "http://20.254.253.173/api/v1/urlImageHotel/?HotelId=" + hotelId,
      method: "GET",
      success: function (data) {
        console.log(data);
  ...
  $(document).on("click", ".delete-image-btn", function () {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $.ajax({
          url:
            "http://20.254.253.173/api/v1/urlImageHotel/?HotelId=" + hotelId1,
          method: "GET",
          success: function (data) {
            // console.log(data);
            // Xử lý khi nhận được danh sách các ảnh từ server
  ...
  $("#confirm").on("click", function () {
    ...
    $.ajax({
      url: "http://20.254.253.173/api/v1/urlImageHotel",
      method: "POST",
      data: formData,
