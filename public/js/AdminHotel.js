$(document).ready(function () {
  ...
  function renderPage() {
    $.ajax({
      url: "http://20.254.253.173/api/v1/users/getAllUser",
      method: "GET",
  ...
  $(".confirm-delete-user").click(function () {
    ...
    $.ajax({
      url: `http://20.254.253.173/api/v1/users/deleteUser/${id}`,
      method: "DELETE",
      success: function (data) {
        // Xử lý thành công
        $(".popup-overlay-delete").hide();
  ...
  $(".dkbutton").click(function () {
    ...
    $.ajax({
      url: `http://20.254.253.173/api/v1/users/register`,
      method: "POST",
      headers: {
  ...
  $(document).on("click", ".fa-image", function () {
    ...
    $.ajax({
      url: "http://20.254.253.173/api/v1/urlImageHotel/?HotelId=48",
      method: "GET",
      success: function (data) {
        console.log(data);
  ...
  $(document).on("click", ".delete-image-btn", function () {
    ...
    $.ajax({
      url: "http://20.254.253.173/api/v1/urlImageHotel/?id=" + id,
      method: "DELETE",
  ...
  $(document).on("click", "#deleteImageBtn", function () {
    ...
    $.ajax({
      url: "http://20.254.253.173/api/images/delete",
      method: "POST",
  ...
  $(document).on("click", ".editUser", function () {
    ...
    $.ajax({
      url: `http://20.254.253.173/api/v1/users/getDetailUser/${id}`,
      method: "GET",
      success: function (data) {
        console.log("2");
        console.log(data);
        ...
        $(".ebutton").click(function () {
          ...
          $.ajax({
            url: `http://20.254.253.173/api/v1/users/editUser/${id}`,
            method: "PUT",
            headers: {
              "Content-Type": "application/json",
            },
