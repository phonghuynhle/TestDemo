$(document).ready(function () {
  ...
  function renderPage() {
    $.ajax({
      url: "http://20.254.253.173/api/v1/rooms/",
      method: "GET",
  ...
  $(document).on("click", ".confirm-delete", function () {
    ...
    $.ajax({
      url: `http://20.254.253.173/api/v1/rooms/${id}`,
      method: "DELETE",
      success: function (data) {
        renderPage();
        $(".popup-overlay-delete").hide();
  ...
  $(document).on("click", ".fa-image", function () {
    ...
    $.ajax({
      url: "http://20.254.253.173/api/v1/urlImageRoom/?IdRoom=" + IdRoom,
      method: "GET",
      success: function (data) {
        console.log(data);
  ...
  $(document).on("click", ".delete-image-btn", function () {
    ...
    $.ajax({
      url: "http://20.254.253.173/api/v1/urlImageRoom/" + id,
      method: "DELETE",
      contentType: "application/json",
  ...
  $("#confirm").on("click", function () {
    ...
    $.ajax({
      url: "http://20.254.253.173/api/v1/urlImageRoom",
      method: "POST",
      data: formData,
